...
The text file HARbySGS.txt contains information about a total of 68 variables, with 180 different observations for each of them, i.e., the file contains 68 columns and 180 rows of data - plus a row with a header at the beginning -. These data were collected during the experiment *Human Activity Recognition Using Smartphones* described in: http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones
